...
namespace VirtoCommerce.CustomerSegmentsModule.Data.JsonConverters
{
    public class CustomerSegmentConditionJsonConverter : ConditionJsonConverter
    {
        public CustomerSegmentConditionJsonConverter(bool doNotSerializeAvailCondition = false)
